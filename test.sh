...
cat boot-rt1.lua test.lua | wasmer run test-boot.wasm | wat2wasm -o test-stage1.wasm -
cat boot-rt1.lua test.lua | wasmtime run test-boot.wasm | wat2wasm -o test-stage2.wasm -
printf foobarbaz | lua -l boot-rt0 test.lua >test-stage0.dat
printf foobarbaz | wasmer run test-stage1.wasm >test-stage1.dat
printf foobarbaz | wasmtime run test-stage1.wasm >test-stage2.dat
